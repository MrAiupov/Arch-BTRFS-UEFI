...
13. После создания первого снимка в `Timeshift`, обязательно нужно один раз обновить список пукнтов `Grub2` командой `sudo grub-mkconfig -o /boot/grub/grub.cfg`
