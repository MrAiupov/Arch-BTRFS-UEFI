...
Скрипты можно скачать и запускать локально во время уставноки Arch Linux, либо клонировать их в свой гитхаб, и создать на каждый скрипт сокрёщенную ссылку через git.io, для это будет достаточно загрузить их свой гитхаб, открыть каждый скрипт в режиме `RAW`, скопировать ссылку и сократить через генератор git.io. Я собственно этим способом и режим запускать данные скрипты. Я мог бы сократить его до одного скрипта, но есть пару моментов, которые я не смог реализовать на `bash`.
